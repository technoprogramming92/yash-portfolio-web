      ...
      <main className="flex w-full flex-col items-center justify-center">
        <Layout className="pt-16">
          ...
          <div className="grid w-full grid-cols-8 gap-16 sm:gap-8">
            <div className="col-span-3 flex flex-col items-start justify-start xl:col-span-4 md:order-2 md:col-span-8 md:flex md:flex-col">
            ...
            <div className="col-span-3 relative h-max rounded-2xl border-2 border-solid border-[#f5f5f5] bg-light p-8 xl:col-span-4 md:order-1 md:col-span-8 md:flex md:flex-col">
            ...
            <div className="col-span-2 flex flex-col items-end justify-between xl:col-span-8 xl:flex-row xl:items-center md:order-3 md:flex md:flex-col">
              <div className="flex flex-col items-end justify-center">
                <span className="inline-block text-7xl font-bold">
                  <AnimatedNumbers value={50} />+
                </span>
                <h2 className="text-xl font-medium capitalize text-[#f5f5f5]">
                  satisfied clients
                </h2>
              </div>
